...
/**
 * Color picker popover backed by react-color's Chrome picker.
 *
 * @since x.x.x
 * @param {Object}   props           Component props.
 * @param {Object}   props.value     Current color value.
 * @param {Function} props.onChange  Color change handler.
 * @param {string}   props.placement Popover placement.
 * @param {any}      props.children  Trigger element.
 */
const ColorPicker = ( {
	value,
	onChange,
	...
	return (
		<Popover className="relative flex items-center">
			...
			<Popover.Panel
				ref={ popperReference }
				className="absolute z-10 bg-white rounded-sm overflow-hidden shadow-lg"
			>
				<Chrome
